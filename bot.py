        ...
        messages = [
            {
                "role": "system",
                "content": (
                    "Составь краткое описание файла ровно 5–6 строк. "
                    "Опиши суть и предназначение — что именно можно найти внутри. "
                    "Не пересказывай текст построчно, не выводи код, XML-теги, "
                    "JSON-структуры, HTML-разметку, необработанные строки таблиц. "
                    "Не упоминай имя файла — оно уже отображается отдельно. "
                    "Отвечай по-русски, кратко и информативно. "
                    ...
                    "Заканчивай ответ содержательной информацией о файле."
                ),
            },
